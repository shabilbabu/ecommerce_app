...
class HorizontalCustomCardWithoutDelete extends StatelessWidget {
  const HorizontalCustomCardWithoutDelete({Key? key,required this.images, required this.colorList, required this.sizedlist}) : super(key: key);
